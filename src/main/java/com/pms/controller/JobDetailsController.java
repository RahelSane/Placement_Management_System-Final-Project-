...
public class JobDetailsController 
{
	...
	CompanyDetailsService companyDetailsService;
		...
		//MAPPING OF ADD JOB DETAILS IN COMPANY MODULE
		...
		//MAPPING OF VIEW JOB DETAILS IN COMPANY MODULE
		...
		//MAPPING OF VIEW JOB DETAILS IN ADMIN MODULE
		...
		//VIEW JOB DETAILS FOR APPLYING JOB
		@GetMapping("/ViewJob")
