 ...
 */
  ...
  {
	  List<AppliedJob> appliedJob1 = this.appliedJobService.getAllAppliedJobByJobId();
  ...
  @GetMapping("/studentlist1") 
  public String applicantlist1(Model model) 
  {
	  List<AppliedJob> appliedJob1 = this.appliedJobService.getAllAppliedJobByJobId();
	  model.addAttribute("appliedjobObj1", appliedJob1); 
	  
	  return "company/studentlist1"; 
  }
  
  @GetMapping("/applicantlist1") 
  public String applicant1(Model model) 
  {
	  List<JobDetails> applicant = this.jobDetailsService.getAllJobDetails();
	  model.addAttribute("applicantobj", applicant); 
	  
	  return "company/applicantlist1"; 
  }
